...
void mtt_kernel::init(std::uint32_t max_conv_size,std::uint32_t P0){
	try{
...
std::uint32_t mtt_kernel::get_P(){return P;}

math::lmi ntt_kernel::get_li(){return li;}

math::lmi mtt_kernel::get_li(){return li;}
...
std::vector<math::mi> mtt_kernel::mul(std::vector<math::mi> mtt_kernel_poly_input1,std::vector<math::mi> mtt_kernel_poly_input2){
	CHECK_INITED;
...
std::vector<math::mi> mtt_kernel::add(std::vector<math::mi> mtt_kernel_poly_input1,std::vector<math::mi> mtt_kernel_poly_input2){
	CHECK_INITED;
...
std::vector<math::mi> mtt_kernel::sub(std::vector<math::mi> mtt_kernel_poly_input1,std::vector<math::mi> mtt_kernel_poly_input2){
	CHECK_INITED;
