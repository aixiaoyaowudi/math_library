...
public:
  ...
  std::vector<math::mi> mul (std::vector<math::mi> ntt_kernel_poly_input1,
                             std::vector<math::mi> ntt_kernel_poly_input2);
  std::vector<math::mi> add (std::vector<math::mi> ntt_kernel_poly_input1,
                             std::vector<math::mi> ntt_kernel_poly_input2);
  std::vector<math::mi> sub (std::vector<math::mi> ntt_kernel_poly_input1,
                             std::vector<math::mi> ntt_kernel_poly_input2);
  ...
  std::vector<math::mi>
  integrate (std::vector<math::mi> ntt_kernel_poly_input1);
  std::vector<math::mi>
  derivative (std::vector<math::mi> ntt_kernel_poly_input1);
  std::vector<math::mi>
  multipoint_eval_interpolation (std::vector<math::mi> ntt_kernel_poly_input1,
                                 std::vector<math::mi> ntt_kernel_poly_input2);
  std::vector<math::mi>
  lagrange_interpolation (std::vector<math::mi> ntt_kernel_poly_input1,
                          std::vector<math::mi> ntt_kernel_poly_input2);
  ~ntt_kernel ();
};
