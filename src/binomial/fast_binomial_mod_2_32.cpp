...
ui
binomial::fast_binomial_mod_2_32::factorial_odd (ui k)
{
  ui ans = 1;
  while (k)
    {
...
ui
binomial::fast_binomial_mod_2_32::factorial (ui k)
{
  ui cnt2 = 0;
  while (k)
    {
...
ui
binomial::fast_binomial_mod_2_32::binomial (ui upper, ui lower)
{
  if (upper < lower)
    return 0;
  ui cnt2 = __builtin_popcount (lower) + __builtin_popcount (upper - lower)
            - __builtin_popcount (upper);
  if (cnt2 >= 32)
    return 0;
  ui c
